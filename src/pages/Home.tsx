            ...
            <div className="relative">
              <img
                ...
                onError={(e) => {
                  ...
                  target.src = 'https://images.unsplash.com/photo-1601758228041-f3b2795255f1?w=600&h=400&fit=crop&crop=center';
                }}
              />
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-50 rounded-xl p-6">
              ...
              <div className="flex items-center">
                <img 
                  src="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=100&h=100&fit=crop&crop=face&face=center"
                  alt="Emily L." 
                  className="w-10 h-10 rounded-full object-cover mr-3"
                />
                <div>
