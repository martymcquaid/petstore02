      ...
      <div className="min-h-screen bg-white dark:bg-gray-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300">Sorry, we couldn't find the category you're looking for.</p>
          </div>
        </div>
        <Footer />
      </div>
    ...
    <div className="min-h-screen bg-white dark:bg-gray-900">
      ...
      <section className="bg-gradient-to-r from-teal-50 to-cyan-50 dark:from-gray-800 dark:to-gray-900 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">{category.name} Products</h1>
